...
export type WorkflowTimer = { timer_id: string; session_id: string | null; execution_id: string; node_id: string; status: string; due_at: string; attempt_count: number; max_attempts: number; retry_delay_seconds: number; last_error: string | null; cancelled_at: string | null; created_at: string; updated_at: string }
