...
export const PLAIN_TEXT_CLASS = 'text-[13px] leading-[1.7] whitespace-pre-wrap text-slate-700'
...
export function SafeHtml({ html, className }: SafeHtmlProps) {
  ...
  return <div className={className ?? RICH_TEXT_CLASS} dangerouslySetInnerHTML={{ __html: sanitized }} />
}
