...
export function ErrorState({ message }: { message: string }) { return <motion.p className="async-error" role="alert" initial={{ opacity: 0, y: 4 }} animate={{ opacity: 1, y: 0 }}><AlertCircle size={16} />{message}</motion.p> }
