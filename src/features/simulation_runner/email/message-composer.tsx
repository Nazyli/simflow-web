      ...
      <div className="flex flex-col gap-2 p-4">
        ...
        <div className="flex gap-2">
          <input
            ...
            className="min-h-[36px] min-w-0 flex-1 rounded-lg border border-[#e8eaed] bg-[#f6f8fb] px-3 py-2 text-sm text-[#1a1a2e] transition-colors outline-none focus:border-[#9929EA] focus:ring-2 focus:ring-purple-100 disabled:bg-[#f1f3f4] disabled:text-[#9aa0a6]"
          />
          <button
            type="button"
            disabled={disabled}
            onClick={() => setActorPickerOpen(true)}
            className="min-h-[36px] shrink-0 rounded-lg border border-[#e8eaed] px-3 py-2 text-sm font-medium text-[#5f6368] transition-colors hover:border-[#9929EA] hover:text-[#9929EA] disabled:opacity-50"
          >
            Pick actor
          </button>
        </div>
        ...
        <input
          ...
          className="min-h-[36px] w-full rounded-lg border border-[#e8eaed] bg-[#f6f8fb] px-3 py-2 text-sm text-[#1a1a2e] transition-colors outline-none focus:border-[#9929EA] focus:ring-2 focus:ring-purple-100 disabled:bg-[#f1f3f4] disabled:text-[#9aa0a6]"
        />
        ...
        <textarea
          ...
          className="min-h-[80px] w-full resize-y rounded-lg border border-[#e8eaed] bg-[#f6f8fb] px-3 py-2 text-sm text-[#1a1a2e] transition-colors outline-none focus:border-[#9929EA] focus:ring-2 focus:ring-purple-100 disabled:bg-[#f1f3f4] disabled:text-[#9aa0a6]"
        />
        ...
        <div className="flex items-center justify-between pt-1">
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-lg border border-[#e8eaed] px-3 py-2 text-sm font-medium text-[#5f6368] transition-colors hover:border-[#9929EA] hover:text-[#9929EA] disabled:opacity-50"
          >
            <Paperclip size={15} />
            Attach
          </button>
          <button
            type="submit"
            disabled={!hasTarget || disabled}
            className="inline-flex items-center gap-1.5 rounded-lg bg-[#9929EA] px-4 py-2 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-[#7d1fc2] disabled:opacity-50"
          >
            <Send size={15} />
            Send
          </button>
