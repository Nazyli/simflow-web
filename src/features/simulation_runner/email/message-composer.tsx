      ...
      <div className="flex flex-col gap-2">
        {target && (
          <div className="flex items-center gap-2">
            ...
            <span className="inline-flex items-center gap-1.5 rounded-md bg-violet-50 px-2 py-0.5 text-xs font-semibold text-[#5b46c5]">
              <span className="grid size-4 place-items-center rounded-full bg-[#5b46c5] text-[9px] font-bold text-white">
        ...
        <input
          ...
          required
          disabled={!canSend}
          placeholder={canSend ? 'Subject' : 'Select a conversation to reply.'}
        ...
        <div className="flex items-end gap-2">
          <textarea
            ...
            required
            disabled={!canSend}
            placeholder={canSend ? 'Write a reply…' : 'Select a conversation to reply.'}
